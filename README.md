...
- Consumo de Energia, como Gas (por Galpon) y electricidad
...
- Gráficos de aumento de Peso de Pollos
- Gráficos de Comparacion de Desarrollo Nominal de diferentes Raza con las de actual Raza (Lote)
...
### 10.2. Scripts de Inicio (en caso de ser necesario)
...
## 13. Ayudas al Usuario
- Wiki para manejos de GRanjas y el Sistema
- BOT para interactuar y recibir respuestas inmediato
- FAQ

## 14. Extensiones
- Modulos para Sensores de Control de Ambiente
- Modulos para Reporte y Alarmas ( CCTV y Enfermedades y otros Alarmas)
- Modulo para hacer pedidos internos y externos
- Modulo para Soporte
