...
class Alimento(models.Model):
    ...
    codigo = models.CharField(max_length=20, unique=True, null=True, blank=True, verbose_name="Código", default='')
    nombre = models.CharField(max_length=100, verbose_name="Nombre del Alimento", default='Alimento sin nombre')
    descripcion = models.TextField(blank=True, verbose_name="Descripción", default='')
    etapa = models.CharField(max_length=20, choices=ETAPA_CHOICES, verbose_name="Etapa", default='INICIADOR')
    proteina_porcentaje = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="Proteína (%)", 
                                           validators=[MinValueValidator(0)], default=0)
    energia_metabolizable_kcal_kg = models.PositiveIntegerField(verbose_name="Energía Metabolizable (Kcal/kg)", default=3000)
    stock_kg = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name="Stock (kg)")
    precio_kg = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Precio por kg", default=0)
    proveedor = models.ForeignKey(Proveedor, on_delete=models.SET_NULL, null=True, blank=True, 
                                 related_name='alimentos', verbose_name="Proveedor")
    fecha_vencimiento = models.DateField(null=True, blank=True, verbose_name="Fecha de Vencimiento")
    lote_fabricante = models.CharField(max_length=50, blank=True, verbose_name="Lote del Fabricante", default='')
...
class ConsumoAlimento(models.Model):
    ...
    fecha_registro = models.DateTimeField(null=True, blank=True, verbose_name="Fecha de Registro")
