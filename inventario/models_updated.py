...
class ConsumoAlimento(models.Model):
    ...
    lote = models.ForeignKey('produccion.Lote', on_delete=models.CASCADE, related_name='consumos_alimento', verbose_name="Lote")
    ...
    def __str__(self):
        return f"{self.cantidad_kg}kg de {self.alimento} - {self.lote} - {self.fecha_consumo}"
...
class AplicacionVacuna(models.Model):
    ...
    lote = models.ForeignKey('produccion.Lote', on_delete=models.CASCADE, related_name='aplicaciones_vacuna', verbose_name="Lote")
    ...
    def __str__(self):
        return f"{self.vacuna} - {self.lote} - {self.fecha_aplicacion}"
