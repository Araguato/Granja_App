...
admin.site.register(ConsumoAlimento, ConsumoAlimentoAdmin)
admin.site.register(AplicacionVacuna, AplicacionVacunaAdmin)
...
admin.site.register(GuiaDesempenoRaza, GuiaDesempenoRazaAdmin)
