    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moneda', models.CharField(default='USD', max_length=10, verbose_name='Moneda Base')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('ADMIN', 'Administrador'), ('SUPERVISOR', 'Supervisor'), ('VETERINARIO', 'Veterinario'), ('OPERARIO', 'Operario')], default='OPERARIO', max_length=20, verbose_name='Tipo de Usuario')),
