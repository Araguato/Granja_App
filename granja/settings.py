...
# URL where requests are redirected after login when no 'next' parameter is present
LOGIN_REDIRECT_URL = 'core:dashboard'

# URL where requests are redirected for login
LOGIN_URL = 'avicola:login'

# URL where requests are redirected after logout
LOGOUT_REDIRECT_URL = 'avicola:avicola_home'
...
MIDDLEWARE = [
    ...
    'avicola.language_middleware.LanguageMiddleware',  # Middleware personalizado
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    # 'core.middleware.SupervisorPermissionsMiddleware',  # Deshabilitado temporalmente
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'avicola', 'templates', 'avicola'),
...
LOGIN_URL = 'avicola:login'
LOGIN_REDIRECT_URL = 'core:dashboard'
LOGOUT_REDIRECT_URL = 'avicola:login'
...
# Login settings
LOGIN_REDIRECT_URL = 'avicola:dashboard'  # Redirect to dashboard after login
LOGOUT_REDIRECT_URL = 'avicola:login'  # Use URL name for consistency
LOGIN_URL = 'avicola:login'  # Use URL name for consistency
...
# Navigation settings
DASHBOARD_URLS = {
    'supervisor': 'avicola:dashboard_supervisor',
    'operario': 'avicola:dashboard_operario',
    'admin': 'admin:index'  # This is the default admin URL name
}
...
SUMMERNOTE_CONFIG = {
    # Using SummernoteWidget for all text fields by default
    'iframe': True,
    'summernote': {
...
MIDDLEWARE = [
    ...
    'avicola.language_middleware.LanguageMiddleware',
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
